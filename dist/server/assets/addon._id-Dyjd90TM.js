...
import { R as Route, L as Link } from "./router-BNfELQi1.js";
import { c as createLucideIcon, u as useFavorites, b as useViewCount, H as Header, a as Heart } from "./Header-CTqlX3-v.js";
import { P as Play, Y as YouTubeModal } from "./YouTubeModal-DP6QrNhv.js";
import { A as ArrowLeft } from "./arrow-left-CR93c8uU.js";
import { T as Tag, D as Download, S as Star, C as Calendar } from "./tag-Bp_a7d2f.js";
import { H as Hash, U as User, E as Eye } from "./user-B3xj3nCa.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "brut p-6 md:p-8 mb-8 bg-orange relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col md:flex-row gap-6 items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: addon.downloadUrl, target: "_blank", rel: "noreferrer", onClick: bump, className: "btn-download mega", "aria-label": `Download ${addon.title}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-7", strokeWidth: 3 }),
              " Download"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => toggle(addon.id), className: `size-14 rounded-md border-[3px] border-ink grid place-items-center transition ${fav ? "bg-ink" : "bg-paper"}`, style: {
            ...
            addon.youtubeId && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setTutorialOpen(true), className: "inline-flex items-center gap-2 px-5 py-3 rounded-md border-[3px] border-ink bg-paper font-display text-lg uppercase brut-press", style: {
              boxShadow: "6px 6px 0 0 var(--ink)"
            }, children: [
